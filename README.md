...
The [`utils`](utils) folder provides some necessary functions for constructing the proposed optimization problem.
##  Running the example

[`scaling_sdp_example.mlx`](scaling_sdp_example.mlx) is a fully commented live Matlab script illustrating how to construct and solve the optimization problem (7), extract the primal-dual optimum, and calculate the gradient information.
